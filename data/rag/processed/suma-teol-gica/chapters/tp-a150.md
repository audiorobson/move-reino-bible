# Terceira Parte (TP)
## Capítulo 150: Whether the Mother of God should be worshipped with the adoration of
...
to the king's mother as to the king: whence it is written (3 Kings
2:19) that "a throne was set for the king's mother, and she sat on His
right hand." Moreover, Augustine [*Sermon on the Assumption, work of an
...
sake, yet the rational creature is capable of being venerated for its
own sake. Consequently the worship of "latria" is not due to any mere
rational creature for its own sake. Since, therefore, the Blessed
Virgin is a mere rational creature, the worship of "latria" is not due
to her, but only that of "dulia": but in a higher degree than to other
creatures, inasmuch as she is the Mother of God. For this reason we say
...
Reply to Objection 2: The honor given to the Mother reflects on her
Son, because the Mother is to be honored for her Son's sake. But not in
the same way as honor given to an image reflects on its exemplar:
because the image itself, considered as a thing, is not to be venerated
in any way at all.
Reply to Objection 3: The cross, considered in itself, is not an object
of veneration, as stated above ([4122]AA[4],5). But the Blessed Virgin
