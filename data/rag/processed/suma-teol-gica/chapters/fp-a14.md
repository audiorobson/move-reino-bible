# Primeira Parte (FP)
## Capítulo 14: Whether God is a body?
...
is written: "Let us make man to our image and likeness" (Gn. 1:26). Now
a figure is called an image, according to the text: "Who being the
...
depart from Thee shall be written in the earth" (Jer. 17:13). Therefore
God is a body.
...
already proved ([3]Q[2], A[3]), that God is the First Mover, and is
...
the actuality; nevertheless, absolutely speaking, actuality is prior to
...
quantity; thus, by depth, it signifies His power of knowing hidden
things; by height, the transcendence of His excelling power; by length,
the duration of His existence; by breadth, His act of love for all. Or,
as says Dionysius (Div. Nom. ix), by the depth of God is meant the
incomprehensibility of His essence; by length, the procession of His
all-pervading power; by breadth, His overspreading all things, inasmuch
as all things lie under His protection.
...
Hence, when it is said, "Let us make man to our image and likeness", it
is added, "And let him have dominion over the fishes of the sea" (Gn.
...
He is everywhere, but by the affections of our soul, and by the actions
of that same soul do we withdraw from Him; thus, to draw near to or to
