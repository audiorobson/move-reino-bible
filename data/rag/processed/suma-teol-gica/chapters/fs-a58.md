...
## Capítulo 58: Whether the will moves itself?
...
potentiality, as such" [*Aristotle, Phys. iii, 1]. Now the same is not
in potentiality and in act, in respect of the same. Therefore nothing
...
But the will is always present to itself. If, therefore, it moved
...
above [1067](A[1]). If, therefore, the will move itself, it would
follow that the same thing is at once moved immediately by two movers;
which seems unreasonable. Therefore the will does not move itself.
...
Now, as stated above (Q[8], A[2]), the end is in things appetible, what
the principle is in things intelligible. But it is evident that the
intellect, through its knowledge of the principle, reduces itself from
potentiality to act, as to its knowledge of the conclusions; and thus
it moves itself. And, in like manner, the will, through its volition of
the end, moves itself to will the means.
...
to itself; but the act of the will, whereby it wills an end, is not
...
Reply to Objection 3: The will is moved by the intellect, otherwise
