# Primeira Parte (FP)
## Capítulo 215: Whether the properties presuppose the notional acts?

Objection 1: It would seem that the notional acts are understood before
the properties. For the Master of the Sentences says (Sent. i, D,
xxvii) that "the Father always is, because He is ever begetting the
...
Objection 3: Further, active generation is to paternity as nativity is
