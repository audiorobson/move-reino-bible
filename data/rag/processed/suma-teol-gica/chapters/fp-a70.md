# Primeira Parte (FP)
## Capítulo 70: Whether any name can be applied to God in its literal sense?

Objection 1: It seems that no name is applied literally to God. For all
names which we apply to God are taken from creatures; as was explained
above [64](A[1]). But the names of creatures are applied to God
...
Objection 2: Further, no name can be applied literally to anything if
it should be withheld from it rather than given to it. But all such
names as "good," "wise," and the like are more truly withheld from God
...
eminent way. Hence Dionysius says also that God is above all substance
and all life.
