# Terceira Parte (TP)
## Capítulo 11: Whether after the Incarnation the Person or Hypostasis of Christ is

composite?
Objection 1: It would seem that the Person of Christ is not composite.
For the Person of Christ is naught else than the Person or hypostasis
of the Word, as appears from what has been said [3863](A[2]). But in
the Word, Person and Nature do not differ, as appears from [3864]FP,
Q[39], A[1]. Therefore since the Nature of the Word is simple, as was
shown above ([3865]FP, Q[3], A[7]), it is impossible that the Person of
Christ be composite.
...
ways. First as it is in itself, and thus it is altogether simple, even
...
Reply to Objection 2: This composition of a person from natures is not
so called on account of parts, but by reason of number, even as that in
