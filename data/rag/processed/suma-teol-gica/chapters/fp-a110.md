# Primeira Parte (FP)
## Capítulo 110: Whether true and false are contraries?
...
lie, "They have laid hold on lying" (Jer. 8:5), that is to say, "an
...
be considered that negation neither asserts anything nor determines any
subject, and can therefore be said of being as of not-being, for
...
as stated in Metaph. iv, 4: v. 27; for blindness is not said except of
...
primarily resides. Hence the false is that which is not as apprehended.
To apprehend being, and not-being, implies contrariety; for, as the
...
being, so every evil is founded in some good, and every falsity in some
truth.
...
is nothing contrary to God, considered in Himself, either with respect
to His goodness or His truth, for in His intellect there can be nothing
false. But in our apprehension of Him contraries exist, for the false
opinion concerning Him is contrary to the true. So idols are called
lies, opposed to the divine truth, inasmuch as the false opinion
