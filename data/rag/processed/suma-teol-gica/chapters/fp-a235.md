# Primeira Parte (FP)
## Capítulo 235: Whether a divine person is sent only by the person whence He proceeds
...
Father is sent by no one because He is from no one." Therefore if a
divine person is sent by another, He must be from that other.
...
does not proceed, then the Holy Ghost may be given by a man, although
He proceeds not from him; which is contrary to what Augustine says (De
