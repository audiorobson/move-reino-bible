# Primeira Parte (FP)
## Capítulo 395: Whether there is an active intellect?
...
color of its own nature moves the luminous medium. But in the operation
of the intellect there is no appointed medium that has to be brought
...
things, and something by which it makes all things." Therefore we must
admit an active intellect.
...
perhaps in order to provide intellectual light to the intellect, as
will be explained farther on [640](A[4]). For Plato supposed that the
forms of natural things subsisted apart from matter, and consequently
that they are intelligible: since a thing is actually intelligible from
the very fact that it is immaterial. And he called such forms "species
or ideas"; from a participation of which, he said that even corporeal
...
genera and species of things. But since Aristotle did not allow that
...
the sensitive part all are passive: but in the intellectual part, there
...
required for sight; not for the colors to become actually visible; but
in order that the medium may become actually luminous, as the
Commentator says on De Anima ii. And according to this, Aristotle's
...
disposition of the recipient has nothing to do with the matter. Now the
...
And therefore in order to understand them, the immaterial nature of the
