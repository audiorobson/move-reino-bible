...
## Capítulo 325: Whether there are four cardinal virtues?
...
is clear from what has been said above ([1568]Q[58], A[4]). But that
which directs other things ranks before them. Therefore prudence alone
...
principles, or according to the subjects in which they are: and either
...
"Justice"; or into passions, and then we need two virtues. For the need
of putting the order of reason into the passions is due to their
...
virtue. For there are four subjects of the virtue we speak of now: viz.
the power which is rational in its essence, and this is perfected by
"Prudence"; and that which is rational by participation, and is
...
before another, are reducible to the above four, both as to the subject
and as to the formal principle.