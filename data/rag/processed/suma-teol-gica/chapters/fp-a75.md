# Primeira Parte (FP)
## Capítulo 75: Whether this name "God" is a name of the nature?
...
called from the {theein} [which means to care of] and to cherish all
...
from other things. Hence as regards such things the meaning of the name
...
to name God as exercising providence over all; hence Dionysius says
(Div. Nom. ii), "The Deity watches over all with perfect providence and
...
Reply to Objection 2: We can name a thing according to the knowledge we
have of its nature from its properties and effects. Hence because we
can know what stone is in itself from its property, this name "stone"
...
the name signifies is the definition, as is said in Metaph. iv. Now
from the divine effects we cannot know the divine nature in itself, so
as to know what it is; but only by way of eminence, and by way of
causality, and of negation as stated above ([70]Q[12], A[12]). Thus the
