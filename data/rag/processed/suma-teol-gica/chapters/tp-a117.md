# Terceira Parte (TP)
## Capítulo 117: Whether in Christ there was a will of sensuality besides the will of reason?
...
sensuality signifies the sensitive appetite. Hence in Christ there was
...
[4074](A[1]). But in Christ there was only one nature besides the
...
are given to understand that sorrow pertains to the human will of
Christ. Now sorrow pertains to the sensuality, as was said in the
[4075]FS, Q[23], A[1]; [4076]FS, Q[25], A[1]. Therefore, seemingly, in
...
or the sensual appetite, inasmuch as it naturally obeys reason, is said
to be "rational by participation," as is clear from the Philosopher
(Ethic. i, 13). And because "the will is in the reason," as stated
above, it may equally be said that the sensuality is "a will by
participation."
Reply to Objection 1: This argument is based on the will, essentially
...
as regards the nature of the sensuality, which Christ assumed, but as
...
there seems to be only one" (Aristotle, Topic. iii); thus a surface
which is visible by color is one visible thing with the color. So, too,
because the sensuality is called the will, only because it partakes of
the rational will, there is said to be but one human will in Christ,
even as there is but one human nature.