# Primeira Parte (FP)
## Capítulo 495: Whether in the state of innocence generation existed?

Objection 1: It would seem there would have been no generation in the
state of innocence. For, as stated in Phys. v, 5, "corruption is
...
But in the state of innocence man would have lived for ever. Therefore
...
(Etym. v, 4). Therefore there would have been no generation in the
state of innocence.
...
be the direct purpose of nature, or rather of the Author of nature, Who
...
itself corruptible, but it could be preserved from corruption by the
...
(Politic. ii, 5). In the state of innocence, however, the will of men
would have been so ordered that without any danger of strife they would
have used in common, according to each one's need, those things of
which they were masters---a state of things to be observed even now
among many good men.