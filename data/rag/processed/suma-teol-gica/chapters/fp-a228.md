# Primeira Parte (FP)
## Capítulo 228: Whether a divine person can be properly sent?
...
Reply to Objection 1: Mission implies inferiority in the one sent, when
it means procession from the sender as principle, by command or
...
origin, which is according to equality, as explained above ([364]Q[42],
AA[4],6).
