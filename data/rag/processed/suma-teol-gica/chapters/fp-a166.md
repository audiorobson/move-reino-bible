# Primeira Parte (FP)
## Capítulo 166: Whether the procession of love in God is generation?

Objection 1: It would seem that the procession of love in God is
generation. For what proceeds by way of likeness of nature among living
things is said to be generated and born. But what proceeds in God by
...
is applicable but generation. Therefore the procession of love in God
is generation.
...
the will differ in this respect, that the intellect is made actual by
...
one procession is distinguished from another, cannot be on the part of
...
love.
Reply to Objection 3: We can name God only from creatures ([234]Q[13],
A[1]). As in creatures generation is the only principle of
communication of nature, procession in God has no proper or special
name, except that of generation. Hence the procession which is not
generation has remained without a special name; but it can be called
