# Primeira Parte (FP)
## Capítulo 25: Whether goodness differs really from being?
...
all desire their own perfection. But everything is perfect so far as it
is actual. Therefore it is clear that a thing is perfect so far as it
exists; for it is existence that makes all things actual, as is clear
from the foregoing ([22]Q[3], A[4]; [23]Q[4], A[1]). Hence it is clear
that goodness and being are the same really. But goodness presents the
...
something actually is, and actuality properly correlates to
...
potentiality; and this is precisely each thing's substantial being.
...
perfection), is not said to be perfect simply nor good simply, but only
relatively. In this way, therefore, viewed in its primal (i.e.
...
Hence the saying of Boethius (De Hebrom.), "I perceive that in nature
