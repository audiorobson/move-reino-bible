# Primeira Parte (FP)
## Capítulo 424: Whether the intelligible species are derived by the soul from certain
...
separate forms.
Objection 2: Further, the intelligible is to the intellect, as the
...
of the sensibles corresponding to that sense.
...
this in two ways. For Plato, as we have said [675](A[1]), held that the
forms of sensible things subsist by themselves without matter; for
instance, the form of a man which he called "per se" man, and the form
or idea of a horse which is called "per se" horse, and so forth. He
said therefore that these forms are participated both by our soul and
by corporeal matter; by our soul, to the effect of knowledge thereof,
and by corporeal matter to the effect of existence: so that, just as
corporeal matter by participating the idea of a stone, becomes an
individuating stone, so our intellect, by participating the idea of a
stone, is made to understand a stone. Now participation of an idea
...
reason, as we have said above [676](A[1]), he referred sciences and
...
respect, that Avicenna held that the intelligible species do not remain
in our intellect after it has ceased actually to understand, and that
it needs to turn (to the active intellect) in order to receive them
anew. Consequently he does not hold that the soul has innate knowledge,
as Plato, who held that the participated ideas remain immovably in the
soul.
...
to the intellectual soul, for the latter's proper operation which is to
...
need the body in order to understand: wherefore to no purpose would it
...
by our intellect are reduced, as to their first cause, to a first
principle which is by its essence intelligible---namely, God. But they
proceed from that principle by means of the sensible forms and material
...
intellect, which is a power of the soul, as we have said ([677]Q[79],
A[4]); and not by a separate intelligence, as proximate cause, although
