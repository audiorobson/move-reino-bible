# Primeira Parte (FP)
## Capítulo 27: Whether every being is good?
...
does not imply desirability, but rather that which desires. Therefore
primary matter does not contain the formality of goodness. Therefore
not every being is good.
...
sort of perfection; and perfection implies desirability and goodness,
as is clear from A[1]. Hence it follows that every being as such is
good.
...
Reply to Objection 3: As primary matter has only potential being, so it
is only potentially good. Although, according to the Platonists,
...
which itself has the aspect of moving another. Nor is it repugnant that
there should be in some logical entity neither goodness nor form of
goodness; since the idea of being is prior to the idea of goodness, as
