...
## Capítulo 355: Whether it suffices to restore the exact amount taken?

Objection 1: It would seem that it is not sufficient to restore the
exact amount taken. For it is written (Ex. 22:1): "If a man shall steal
an ox or a sheep and kill or sell it, he shall restore five oxen for
one ox, and four sheep for one sheep." Now everyone is bound to keep
the commandments of the Divine law. Therefore a thief is bound to
restore four- or fivefold.
Objection 2: Further, "What things soever were written, were written
for our learning" (Rom. 15:4). Now Zachaeus said (Lk. 19:8) to our
Lord: "If I have wronged any man of any thing, I restore him fourfold."
...
regards the sin, the remedy is applied by punishment, the infliction of
which belongs to the judge: and so, until a man is condemned by the
...
is bound to keep the judicial precepts, as stated above ([2891]FS,
Q[104], A[3]). Nevertheless the same might be determined by human law,
and then the same answer would apply.
Reply to Objection 2: Zachaeus said this being willing to do more than
he was bound to do; hence he had said already: "Behold . . . the half
