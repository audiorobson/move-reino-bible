...
## Capítulo 41: Whether faith has the effect of purifying the heart?
...
for silver is not called impure, when mixed with gold, which betters
it, but when mixed with lead or tin. Now it is evident that the
...
this movement is faith: since "he that cometh to God must believe that
...
when it is quickened by charity, then it is incompatible with any kind
...
impurity of sin, but rather to the natural defect of the human
