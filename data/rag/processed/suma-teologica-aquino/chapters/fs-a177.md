...
## Capítulo 177: Whether delight differs from joy?
...
delight and joy have the same object, namely, a good obtained.
Therefore joy is altogether the same as delight.
Objection 2: Further, one movement does not end in two terms. But one
and the same movement, that of desire, ends in joy and delight.
Therefore delight and joy are altogether the same.
Objection 3: Further, if joy differs from delight, it seems that there
is equal reason for distinguishing gladness, exultation, and
...
we do speak of delight in them. Therefore joy is not the same as
delight.
...
above ([1262]Q[30], A[3]), so also some delights are natural, and some
are not natural but rational. Or, as Damascene (De Fide Orth. ii, 13)
and Gregory of Nyssa [*Nemesius, De Nat. Hom. xviii.] put it, "some
...
Reply to Objection 1: Since the object of the appetite of the soul is
an apprehended good, diversity of apprehension pertains, in a way, to
...
concupiscences ([1263]Q[30], A[3], ad 2).
...
derived from the effects of delight; for "laetitia" [gladness] is
