...
## Capítulo 372: Whether the fruits differ from the beatitudes?
...
above ([1676]Q[69], A[1], ad 1). But the gifts perfect man in so far as
he is moved by the Holy Ghost. Therefore the beatitudes themselves are
...
beatitude. Therefore the fruits of the present life are the beatitudes.
...
([1677]Q[3], A[1];[1678] Q[4], A[1]). Therefore fruit and beatitude
have the same nature, and consequently should not be distinguished from
one another.
...
is clear from the way in which they are enumerated. Therefore the
...
virtues, as already stated ([1679]Q[69], A[1], ad 1).
