...
## Capítulo 454: Whether any other special sins, besides pride and avarice, should be called

capital?
Objection 1: It would seem that no other special sins, besides pride
and avarice, should be called capital. Because "the head seems to be to
...
called the "root of all evils," it seems that it alone, and no other
...
govern others are called heads. Accordingly a capital vice is so
called, in the first place, from "head" taken in the proper sense, and
thus the name "capital" is given to a sin for which capital punishment
is inflicted. It is not in this sense that we are now speaking of
capital sins, but in another sense, in which the term "capital" is
derived from head, taken metaphorically for a principle or director of
others. In this way a capital vice is one from which other vices arise,
chiefly by being their final cause, which origin is formal, as stated
...
Gregory (Moral. xxxi, 17) compares these capital vices to the "leaders
of an army."
...
God, for in this respect it is an evil, and evil, according to
...
from the punishment it deserves, in which sense we are not taking it
here.