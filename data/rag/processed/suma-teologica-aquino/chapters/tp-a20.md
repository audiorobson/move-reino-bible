# Terceira Parte (TP)
## Capítulo 20: Whether it is befitting for a Divine Person to assume?
...
in some degree to what is assumed to it, just as dignity is
communicated to whosoever is assumed to a dignity. But it is of the
nature of a person to be incommunicable, as was said above ([3876]FP,
Q[29], A[1]). Therefore it is not befitting to a Divine Person to
assume, i.e. to take to Himself.
...
was said above ([3877]Q[2], AA[1] ,2), the union took place in the
...
several natures, for even in a created person several natures may
...
to be man. It is by the Divine Nature that a Divine Person is
constituted simply. Hence the Divine Person is not said to assume the
Divine Nature, but to assume the human nature.