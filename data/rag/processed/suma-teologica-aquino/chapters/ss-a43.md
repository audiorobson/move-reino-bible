...
## Capítulo 43: Whether the gift of understanding is compatible with faith?

Objection 1: It would seem that the gift of understanding is
incompatible with faith. For Augustine says (QQ. lxxxiii, qu. 15) that
"the thing which is understood is bounded by the comprehension of him
who understands it." But the thing which is believed is not
...
([2357]Q[1], A[4];[2358] Q[4], A[1]). Therefore faith is incompatible
with understanding in the same subject.
...
([2359]Q[1], AA[4],5). Much less, therefore, can understanding and
...
thus it is written (Lk. 24:27, 32) that Our Lord opened the scriptures
...
another, to those just mentioned, for instance, all that is contained
...
we understand a thing perfectly, when we arrive at knowing the essence
of the thing we understand, and the very truth considered in itself of
the proposition understood. In this way, so long as the state of faith
lasts, we cannot understand those things which are the direct object of
faith: although certain other things that are subordinate to faith can
...
mode of being, and yet we know that whatever be the outward
...
state of faith, nothing hinders us from understanding even those things
which are the direct object of faith.
